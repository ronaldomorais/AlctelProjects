...
/****** Object:  StoredProcedure [dbo].[TESTE_Alc_Paae_001_sp_hiPesquisaSatisfacaoDetalheAgente_20221108_BKP]    Script Date: 08/11/2022 12:29:04 ******/
SET ANSI_NULLS ON
GO
...
--DECLARE
--	@dataInicial VARCHAR(10) = '2022-08-15'
--	,@dataFinal VARCHAR(10)  = '2022-08-15'
--	,@parSite INT = 11

CREATE PROCEDURE [dbo].[TESTE_Alc_Paae_001_sp_hiPesquisaSatisfacaoDetalheAgente_20221108_BKP] 
...
--PROC Alc_Paae_001_sp_hiPesquisaSatisfacaoDetalhe transcrita aqui por causa de proecdures nested
	...
	SELECT [data]
		...
		,CASE 
			WHEN SUM(atendida) > 0
				THEN ROUND(CAST(SUM(respondida_pesquisa) AS FLOAT) / CAST(SUM(atendida) AS FLOAT) * 100, 2)
			ELSE 0
		...
		,SUM(resposta_nota3) + SUM(resposta_nota4) + SUM(resposta_nota5) AS nota_geral_num
