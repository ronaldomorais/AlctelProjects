...
/****** Object:  StoredProcedure [dbo].[TESTE_Alc_Paae_001_sp_hiSumario001Det]    Script Date: 15/03/2023 14:32:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[TESTE_Alc_Paae_001_sp_hiSumario001Det]   
...
BEGIN
	...
	SELECT
		ROW_NUMBER() OVER(ORDER BY S.[data]) AS sequencial 
		,CAST(S.[data] AS DATETIME) AS atualizacao
		,S.cha_fila
		,CAST(S.[data] AS DATETIME) AS horario
		--,S.fila_dbid AS [dbid]
