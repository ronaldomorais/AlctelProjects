...
/****** Object:  StoredProcedure [dbo].[TESTE_Alc_Paae_001_sp_hiSumario001]    Script Date: 15/03/2023 14:32:02 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[TESTE_Alc_Paae_001_sp_hiSumario001]   
...
BEGIN
	...
	GROUP BY S.cha_fila, S.fila_dbid, S.[site]
END
