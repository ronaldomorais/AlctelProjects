...
/****** Object:  StoredProcedure [Alc_rel].[ALC_spGetUserStatusByWorkgroup]    Script Date: 18/06/2023 10:55:49 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [Alc_rel].[ALC_spGetUserStatusByWorkgroup]
	@dataInicio DATETIME
...
BEGIN	
	...
	FROM #tbLoginsIncompletos AS I
		INNER JOIN AgentActivityLog AS A ON A.UserId = I.UserId AND A.StatusDateTime > I.StatusDateTime AND A.LoggedIn = 0
